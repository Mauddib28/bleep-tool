...
> **✅ ARCHIVED (2026-09-13).** One-off v2.2.2 change summary, superseded by the
> [Change log](../changelog.md) and [AoI Implementation](../aoi_implementation.md).
> Its "Future Work" items (DB integration, dedicated tests) are now complete.
