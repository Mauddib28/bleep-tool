...
> **⚠️ ARCHIVED — SUPERSEDED (2026-09-13).** Historical investigation record; do
> **not** treat the "Current Status" below as current. The "methods never invoke"
> symptom was **RESOLVED in v2.6.2** by running the GLib MainLoop during pairing.
> See the canonical [Agent Pairing Flow Analysis](../agent_pairing_flow_analysis.md)
> and [Mainloop Architecture](../mainloop_architecture.md).
