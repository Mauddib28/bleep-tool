...
> **✅ IMPLEMENTED — ARCHIVED (2026-09-13).** This plan is fully implemented
> (`bleep/bt_ref/uuid_translator.py::translate_uuid`, `bleep/modes/uuid_translate.py`,
> CLI `uuid-translate`, `tests/test_uuid_translation.py`). See the shipped-feature
> doc [UUID translation](../uuid_translation.md).
