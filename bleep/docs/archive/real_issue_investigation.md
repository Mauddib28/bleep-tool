...
> **not** treat the "Current Status" below as current. The described failure
> (`org.bluez.Agent1` methods registered but never invoked) was **RESOLVED in
> v2.6.2** by running the GLib MainLoop during pairing. See the canonical
> [Agent Pairing Flow Analysis](../agent_pairing_flow_analysis.md) and
